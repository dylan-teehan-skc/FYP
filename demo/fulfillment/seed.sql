...
-- Return orders (pre-fulfilled/backordered, with order_date)
-- ORD-301: within 30d window → eligible → refund $52.40
-- ORD-302: 49 days ago, past 30d window → NOT eligible
-- ORD-303: backordered → auto-eligible → refund $0
INSERT INTO orders VALUES ('ORD-301', 'C-301', 'P-101', 1, 'fulfilled', 52.40, 2, '2026-02-15');
INSERT INTO orders VALUES ('ORD-302', 'C-302', 'P-102', 1, 'fulfilled', 31.70, 2, '2026-01-10');
INSERT INTO orders VALUES ('ORD-303', 'C-303', 'P-103', 1, 'backordered', NULL, NULL, '2026-02-20');

-- Exchange orders (original fulfilled + replacement pending)
-- ORD-401 original: C-304 bought P-101 from WH-2 → $47.90 / 2d, within window
-- ORD-501 replacement: C-304 wants P-102 → optimal WH-2 $31.70 / 2d
-- ORD-402 original: C-305 bought P-104 from WH-1 → $41.60 / 2d, within window
-- ORD-502 replacement: C-305 wants P-103 → all out of stock → backordered
INSERT INTO orders VALUES ('ORD-401', 'C-304', 'P-101', 1, 'fulfilled', 47.90, 2, '2026-02-20');
INSERT INTO orders VALUES ('ORD-501', 'C-304', 'P-102', 1, 'pending', NULL, NULL, NULL);
INSERT INTO orders VALUES ('ORD-402', 'C-305', 'P-104', 1, 'fulfilled', 41.60, 2, '2026-02-18');
...
INSERT INTO orders VALUES ('ORD-304', 'C-301', 'P-104', 1, 'fulfilled', 41.60, 2, '2026-02-25');
...
INSERT INTO orders VALUES ('ORD-305', 'C-305', 'P-102', 1, 'fulfilled', 36.90, 3, '2026-02-20');
--
-- ORD-403: C-303 bought P-102, return + replacement ORD-503 (P-104)
--   WH-3(central→central): 4+1.5*0.3=$4.45 1d → 29*0.95+4.45 = $32.00 / 1d
INSERT INTO orders VALUES ('ORD-403', 'C-303', 'P-102', 1, 'fulfilled', 32.00, 1, '2026-02-22');
...
INSERT INTO orders VALUES ('ORD-404', 'C-302', 'P-104', 1, 'fulfilled', 40.90, 3, '2026-02-21');
...
-- ORD-306: C-302 bought P-101, fulfilled 2026-02-18, 30d window → eligible
INSERT INTO orders VALUES ('ORD-306', 'C-302', 'P-101', 1, 'fulfilled', 47.90, 2, '2026-02-18');
-- ORD-307: C-304 bought P-102, fulfilled 2026-02-22, 30d window → eligible
INSERT INTO orders VALUES ('ORD-307', 'C-304', 'P-102', 1, 'fulfilled', 31.70, 2, '2026-02-22');
-- ORD-308: C-301 bought P-102, fulfilled 2026-02-10, 30d window → eligible (18 days ago)
INSERT INTO orders VALUES ('ORD-308', 'C-301', 'P-102', 1, 'fulfilled', 36.90, 3, '2026-02-10');
--
-- Additional exchange orders for clustering density
-- ORD-405: C-301 bought P-102, fulfilled 2026-02-19, 30d → eligible
INSERT INTO orders VALUES ('ORD-405', 'C-301', 'P-102', 1, 'fulfilled', 36.90, 3, '2026-02-19');
...
-- ORD-406: C-302 bought P-101, fulfilled 2026-02-21, 30d → eligible
INSERT INTO orders VALUES ('ORD-406', 'C-302', 'P-101', 1, 'fulfilled', 47.90, 2, '2026-02-21');
...
-- ORD-407: C-304 bought P-104, fulfilled 2026-02-17, 14d window → eligible (11 days ago)
INSERT INTO orders VALUES ('ORD-407', 'C-304', 'P-104', 1, 'fulfilled', 40.90, 3, '2026-02-17');
...
-- NEW RETURNS (3)
--
-- ORD-309: C-306 bought P-106, fulfilled 2026-02-20, 30d → eligible → returned
--   WH-1(east→east): 5+2*0.2=$5.40 2d → total: 25*0.95+5.40=$29.15/2d
INSERT INTO orders VALUES ('ORD-309', 'C-306', 'P-106', 1, 'fulfilled', 29.15, 2, '2026-02-20');
-- ORD-310: C-308 bought P-108, fulfilled 2026-02-25, 14d → eligible → returned
--   WH-3(central→west): 7+3*0.4=$8.20 3d → total: 199*0.90+8.20=$187.30/3d
INSERT INTO orders VALUES ('ORD-310', 'C-308', 'P-108', 1, 'fulfilled', 187.30, 3, '2026-02-25');
-- ORD-311: C-307 bought P-106, fulfilled 2026-02-01, 30d → eligible (27 days) → returned
--   WH-4(south→central): 6+2.5*0.2=$6.50 2d → total: 25+6.50=$31.50/2d
INSERT INTO orders VALUES ('ORD-311', 'C-307', 'P-106', 1, 'fulfilled', 31.50, 2, '2026-02-01');
--
-- NEW EXCHANGES (3)
--
-- ORD-410: C-308(vip,west) bought P-107, fulfilled 2026-02-18, 30d → eligible
--   total: 149*0.90 + WH-2(west→west) 5+2*1.0=$7.00 = $141.10/2d
INSERT INTO orders VALUES ('ORD-410', 'C-308', 'P-107', 1, 'fulfilled', 141.10, 2, '2026-02-18');
...
-- ORD-411: C-306(gold,east) bought P-108, fulfilled 2026-02-22, 14d → eligible
--   total: 199*0.95 + WH-3(central→east) 7+3*0.4=$8.20 = $197.25/3d
INSERT INTO orders VALUES ('ORD-411', 'C-306', 'P-108', 1, 'fulfilled', 197.25, 3, '2026-02-22');
...
-- ORD-412: C-303(gold,flagged,central) bought P-106, fulfilled 2026-02-20, 30d → eligible
--   total: 25*0.95 + WH-4(south→central) 6+2.5*0.2=$6.50 = $30.25/2d
INSERT INTO orders VALUES ('ORD-412', 'C-303', 'P-106', 1, 'fulfilled', 30.25, 2, '2026-02-20');
...
INSERT INTO customer_flags VALUES ('C-303', 'suspicious activity pattern', '2026-01-15');
...
INSERT INTO restock_schedule VALUES ('WH-3', 'P-103', '2026-03-05', 20);
